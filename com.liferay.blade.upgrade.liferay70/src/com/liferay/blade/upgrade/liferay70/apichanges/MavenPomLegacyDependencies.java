...
public class MavenPomLegacyDependencies extends XMLFileMigrator implements AutoMigrator {
	...
	protected List<SearchResult> searchFile(File file, XMLFile xmlFileChecker) {
		if ("pom.xml".equals(file.getName())) {
			...
			searchResults.addAll(xmlFileChecker.findLegacyDependency("com.liferay.portal", "portal-service"));
			searchResults.addAll(xmlFileChecker.findLegacyDependency("com.liferay.portal", "util-java"));
			searchResults.addAll(xmlFileChecker.findLegacyDependency("com.liferay.portal", "util-bridges"));
			searchResults.addAll(xmlFileChecker.findLegacyDependency("com.liferay.portal", "util-taglib"));
			searchResults.addAll(xmlFileChecker.findLegacyDependency("com.liferay.portal", "util-slf4j"));
