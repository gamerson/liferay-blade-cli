...
public class ConvertServiceBuilderCommandTest {
	...
	public void testConvertServiceBuilderTasksPortletDefaultName() throws Exception {
		...
		String fileName =
			"modules/tasks/tasks-service/src/main/java/com/liferay/tasks/model/impl/TasksEntryModelImpl.java";

		Assert.assertTrue(new File(testdir, fileName).exists());
	...
	private final File _workspaceDir = IO.getFile("build/test/workspace");
