...
public class FileWatcherTest {
	...
	private final File _testdir = IO.getFile("build/watch");
	private final File _testfile = new File(_testdir, "file.txt");
	private final File _testsecondfile = new File(_testdir, "second.txt");
