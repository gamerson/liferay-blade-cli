...
public class JMXLocalConnector {
	...
	/**
	 * Uses Oracle JDK's Attach API to try to search VMs on this machine looking for
	 * the osgi.core MBeans. This will stop searching for VMs once the MBeans are
	 * found. Beware if you have multiple JVMs with osgi.core MBeans published.
	 *
	 * @return
	 */
			...
			try {
				...
				if (localConnectorAddress != null) {
					...
					if (mBeanServerConnection != null) {
						ObjectName objectName = _getObjectName(name, mBeanServerConnection);
