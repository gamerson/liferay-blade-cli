...
public class AetherClient {
	...
	public Artifact findLatestAvailableArtifact(String groupIdArtifactId) throws ArtifactResolutionException {
		RepositorySystem system = _newRepositorySystem();

		List<RemoteRepository> repos = _repos();

		String range = "[0,)";

		Artifact artifactRange = new DefaultArtifact(groupIdArtifactId + ":" + range);
		...
		RepositorySystemSession session = _newRepositorySystemSession(system, _localRepositoryPath);
