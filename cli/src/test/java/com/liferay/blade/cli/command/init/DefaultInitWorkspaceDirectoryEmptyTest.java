 ...
 */
public class DefaultInitWorkspaceDirectoryEmptyTest extends BaseInitTest {
	...
	public void testDefaultInitWorkspaceDirectoryEmpty() throws Exception {
		...
		Assert.assertTrue(Files.exists(workspaceDir));
		...
		Assert.assertFalse(Files.exists(workspaceDir.resolve("com")));
