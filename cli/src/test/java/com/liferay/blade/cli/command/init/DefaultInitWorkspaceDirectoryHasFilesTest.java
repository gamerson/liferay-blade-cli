...
public class DefaultInitWorkspaceDirectoryHasFilesTest extends BaseInitTest {
	...
	public void testDefaultInitWorkspaceDirectoryHasFiles() throws Exception {
		...
		Path gradlePath = workspaceDir.resolve("build.gradle");
