 ...
 */
public class MavenInitWorkspaceDirectoryHasFilesTest extends BaseInitTest {

	@Test
	public void testMavenInitWorkspaceDirectoryHasFiles() throws Exception {
		String[] args = {"--base", workspaceDir.toString(), "init", "-b", "maven"};

		Path fooPath = Files.createFile(workspaceDir.resolve("foo"));
		...
		Assert.assertFalse(Files.exists(workspaceDir.resolve("pom.xml")));
	}
